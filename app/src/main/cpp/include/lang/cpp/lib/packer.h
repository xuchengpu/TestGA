...
class packer {
 ...
 public:
  void swap(packer& rhs) {
    ...
    rhs.position_ = position_;
    rhs.length_ = length_;
    buffer_.resize(PACKET_BUFFER_SIZE);
    length_ = 0;
    position_ = 2;
  }
 ...
 public:
  ...
  void check_size(size_t more, uint16_t position) {
    if (buffer_.size() - position < more) {
      ...
      if (new_size - position < more)
        new_size = more + position;
...
#define DECLARE_PACKABLE_2(name, type1, name1, type2, name2) \
  ...
  DECLARE_STRUCT_END
#define DECLARE_PACKABLE_3_START(name,                                   \
                                 type1,                                  \
                                 name1,                                  \
                                 type2,                                  \
                                 name2,                                  \
...
#define DECLARE_PACKABLE_3(name, type1, name1, type2, name2, type3, name3) \
  ...
  DECLARE_STRUCT_END
#define DECLARE_PACKABLE_4_START(name,                  \
                                 type1,                 \
                                 name1,                 \
                                 type2,                 \
                                 name2,                 \
...
#define DECLARE_PACKABLE_4(name,  \
                           type1, \
                           name1, \
                           type2, \
                           name2, \
  ...
  DECLARE_PACKABLE_4_START(name,  \
                           ...
                           name4) \
  DECLARE_STRUCT_END
#define DECLARE_PACKABLE_5_START(name,                        \
                                 type1,                       \
                                 name1,                       \
                                 type2,                       \
                                 name2,                       \
...
#define DECLARE_PACKABLE_5(name,  \
                           type1, \
                           name1, \
                           type2, \
                           name2, \
...
#define DECLARE_PACKABLE_6_START(name,                                   \
                                 type1,                                  \
                                 name1,                                  \
                                 type2,                                  \
                                 name2,                                  \
...
#define DECLARE_PACKABLE_6(name,  \
                           type1, \
                           name1, \
                           type2, \
                           name2, \
  ...
  DECLARE_PACKABLE_6_START(name,  \
                           ...
                           name6) \
  DECLARE_STRUCT_END
#define DECLARE_PACKABLE_7_START(name,                                     \
                                 type1,                                    \
                                 name1,                                    \
                                 type2,                                    \
                                 name2,                                    \
...
#define DECLARE_PACKABLE_7(name,  \
                           type1, \
                           name1, \
                           type2, \
                           name2, \
  ...
  DECLARE_PACKABLE_7_START(name,  \
                           ...
                           name7) \
  DECLARE_STRUCT_END
#define DECLARE_PACKABLE_8_START(name,                                     \
                                 type1,                                    \
                                 name1,                                    \
                                 type2,                                    \
                                 name2,                                    \
...
#define DECLARE_PACKABLE_8(name,  \
                           type1, \
                           name1, \
                           type2, \
                           name2, \
  ...
  DECLARE_PACKABLE_8_START(name,  \
                           ...
                           name8) \
  DECLARE_STRUCT_END
#define DECLARE_PACKABLE_9_START(name,                                     \
                                 type1,                                    \
                                 name1,                                    \
                                 type2,                                    \
                                 name2,                                    \
...
#define DECLARE_PACKABLE_9(name,  \
                           type1, \
                           name1, \
                           type2, \
                           name2, \
...
#define DECLARE_PACKABLE_10_START(name,                                    \
                                  type1,                                   \
                                  name1,                                   \
                                  type2,                                   \
                                  name2,                                   \
  ...
  friend packer& operator<<(packer& p, const name& x) {                    \
    p << x.name1 << x.name2 << x.name3 << x.name4 << x.name5 << x.name6    \
      << x.name7 << x.name8 << x.name9 << x.name10;                        \
    return p;                                                              \
  }                                                                        \
  friend unpacker& operator>>(unpacker& p, name& x) {                      \
    p >> x.name1 >> x.name2 >> x.name3 >> x.name4 >> x.name5 >> x.name6 >> \
...
#define DECLARE_PACKABLE_10(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type10, \
                            name10) \
  DECLARE_PACKABLE_10_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
...
#define DECLARE_PACKABLE_11_START(name,                                    \
                                  type1,                                   \
                                  name1,                                   \
                                  type2,                                   \
                                  name2,                                   \
  ...
  friend packer& operator<<(packer& p, const name& x) {                    \
    p << x.name1 << x.name2 << x.name3 << x.name4 << x.name5 << x.name6    \
      << x.name7 << x.name8 << x.name9 << x.name10 << x.name11;            \
    return p;                                                              \
  }                                                                        \
  friend unpacker& operator>>(unpacker& p, name& x) {                      \
    p >> x.name1 >> x.name2 >> x.name3 >> x.name4 >> x.name5 >> x.name6 >> \
...
#define DECLARE_PACKABLE_11(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type11, \
                            name11) \
  DECLARE_PACKABLE_11_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
...
#define DECLARE_PACKABLE_12_START(name,                                     \
                                  type1,                                    \
                                  name1,                                    \
                                  type2,                                    \
                                  name2,                                    \
  ...
  friend packer& operator<<(packer& p, const name& x) {                     \
    p << x.name1 << x.name2 << x.name3 << x.name4 << x.name5 << x.name6     \
      << x.name7 << x.name8 << x.name9 << x.name10 << x.name11 << x.name12; \
    return p;                                                               \
  }                                                                         \
  friend unpacker& operator>>(unpacker& p, name& x) {                       \
    p >> x.name1 >> x.name2 >> x.name3 >> x.name4 >> x.name5 >> x.name6 >>  \
...
#define DECLARE_PACKABLE_12(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type12, \
                            name12) \
  DECLARE_PACKABLE_12_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
...
#define DECLARE_PACKABLE_13_START(name,                                    \
                                  type1,                                   \
                                  name1,                                   \
                                  type2,                                   \
                                  name2,                                   \
...
#define DECLARE_PACKABLE_13(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type13, \
                            name13) \
  DECLARE_PACKABLE_13_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
...
#define DECLARE_PACKABLE_14_START(name,                                    \
                                  type1,                                   \
                                  name1,                                   \
                                  type2,                                   \
                                  name2,                                   \
...
#define DECLARE_PACKABLE_14(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type14, \
                            name14) \
  DECLARE_PACKABLE_14_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
...
#define DECLARE_PACKABLE_15_START(name,                                    \
                                  type1,                                   \
                                  name1,                                   \
                                  type2,                                   \
                                  name2,                                   \
...
#define DECLARE_PACKABLE_15(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type15, \
                            name15) \
  DECLARE_PACKABLE_15_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
...
#define DECLARE_PACKABLE_16_START(name,                                    \
                                  type1,                                   \
                                  name1,                                   \
                                  type2,                                   \
                                  name2,                                   \
  ...
  friend packer& operator<<(packer& p, const name& x) {                    \
    p << x.name1 << x.name2 << x.name3 << x.name4 << x.name5 << x.name6    \
      << x.name7 << x.name8 << x.name9 << x.name10 << x.name11 << x.name12 \
      << x.name13 << x.name14 << x.name15 << x.name16;                     \
    return p;                                                              \
  }                                                                        \
  friend unpacker& operator>>(unpacker& p, name& x) {                      \
    p >> x.name1 >> x.name2 >> x.name3 >> x.name4 >> x.name5 >> x.name6 >> \
...
#define DECLARE_PACKABLE_16(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type16, \
                            name16) \
  DECLARE_PACKABLE_16_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
...
#define DECLARE_PACKABLE_17_START(name,                                    \
                                  type1,                                   \
                                  name1,                                   \
                                  type2,                                   \
                                  name2,                                   \
  ...
  friend packer& operator<<(packer& p, const name& x) {                    \
    p << x.name1 << x.name2 << x.name3 << x.name4 << x.name5 << x.name6    \
      << x.name7 << x.name8 << x.name9 << x.name10 << x.name11 << x.name12 \
      << x.name13 << x.name14 << x.name15 << x.name16 << x.name17;         \
    return p;                                                              \
  }                                                                        \
  friend unpacker& operator>>(unpacker& p, name& x) {                      \
    p >> x.name1 >> x.name2 >> x.name3 >> x.name4 >> x.name5 >> x.name6 >> \
...
#define DECLARE_PACKABLE_17(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type17, \
                            name17) \
  DECLARE_PACKABLE_17_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
...
#define DECLARE_PACKABLE_18_START(name,                                        \
                                  type1,                                       \
                                  name1,                                       \
                                  type2,                                       \
                                  name2,                                       \
  ...
  friend packer& operator<<(packer& p, const name& x) {                        \
    p << x.name1 << x.name2 << x.name3 << x.name4 << x.name5 << x.name6        \
      << x.name7 << x.name8 << x.name9 << x.name10 << x.name11 << x.name12     \
      << x.name13 << x.name14 << x.name15 << x.name16 << x.name17 << x.name18; \
    return p;                                                                  \
  }                                                                            \
  friend unpacker& operator>>(unpacker& p, name& x) {                          \
    p >> x.name1 >> x.name2 >> x.name3 >> x.name4 >> x.name5 >> x.name6 >>     \
...
#define DECLARE_PACKABLE_18(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type18, \
                            name18) \
  DECLARE_PACKABLE_18_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
...
#define DECLARE_PACKABLE_19_START(name,                                       \
                                  type1,                                      \
                                  name1,                                      \
                                  type2,                                      \
                                  name2,                                      \
...
#define DECLARE_PACKABLE_19(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type19, \
                            name19) \
  DECLARE_PACKABLE_19_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
...
#define DECLARE_PACKABLE_20_START(name,                                       \
                                  type1,                                      \
                                  name1,                                      \
                                  type2,                                      \
                                  name2,                                      \
...
#define DECLARE_PACKABLE_20(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type20, \
                            name20) \
  DECLARE_PACKABLE_20_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
...
#define DECLARE_PACKABLE_21_START(name,                                       \
                                  type1,                                      \
                                  name1,                                      \
                                  type2,                                      \
                                  name2,                                      \
...
#define DECLARE_PACKABLE_21(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type21, \
                            name21) \
  DECLARE_PACKABLE_21_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
...
#define DECLARE_PACKABLE_22_START(name,                                       \
                                  type1,                                      \
                                  name1,                                      \
                                  type2,                                      \
                                  name2,                                      \
  ...
  friend packer& operator<<(packer& p, const name& x) {                       \
    p << x.name1 << x.name2 << x.name3 << x.name4 << x.name5 << x.name6       \
      << x.name7 << x.name8 << x.name9 << x.name10 << x.name11 << x.name12    \
      << x.name13 << x.name14 << x.name15 << x.name16 << x.name17 << x.name18 \
      << x.name19 << x.name20 << x.name21 << x.name22;                        \
    return p;                                                                 \
  }                                                                           \
  friend unpacker& operator>>(unpacker& p, name& x) {                         \
    p >> x.name1 >> x.name2 >> x.name3 >> x.name4 >> x.name5 >> x.name6 >>    \
...
#define DECLARE_PACKABLE_22(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
                            ...
                            type22, \
                            name22) \
  DECLARE_PACKABLE_22_START(name,   \
                            type1,  \
                            name1,  \
                            type2,  \
                            name2,  \
